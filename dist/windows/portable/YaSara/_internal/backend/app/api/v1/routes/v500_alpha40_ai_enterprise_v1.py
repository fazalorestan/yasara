...
from app.v500_alpha40_ai_enterprise.service import ai_enterprise_facade_v500_alpha40 as _service

router = APIRouter(prefix="/v5-0-alpha-40/ai-enterprise", tags=["v5.0-alpha.40-ai-enterprise"])
