...
from app.v500_alpha42_execution_enterprise.service import execution_enterprise_facade_v500_alpha42 as _service

router = APIRouter(prefix="/v5-0-alpha-42/execution-enterprise", tags=["v5.0-alpha.42-execution-enterprise"])
