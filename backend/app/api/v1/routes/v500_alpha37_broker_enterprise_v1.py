...
from app.v500_alpha37_broker_enterprise.service import broker_enterprise_facade_v500_alpha37 as _service
router = APIRouter(prefix="/v5-0-alpha-37/broker-enterprise", tags=["v5.0-alpha.37-broker-enterprise"])
@router.get("/summary")
