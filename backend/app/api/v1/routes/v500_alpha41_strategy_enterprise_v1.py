...
from app.v500_alpha41_strategy_enterprise.service import strategy_enterprise_facade_v500_alpha41 as _service

router = APIRouter(prefix="/v5-0-alpha-41/strategy-enterprise", tags=["v5.0-alpha.41-strategy-enterprise"])
